...
export const endpoint = {
   ...
   /*---------------------------------*/
    ...
    REGISTRARASEGURADO:'Asegurados/RegistrarAsegurado',
    CONSULTASEGURADOSID: 'Asegurados/AseguradoID/',
    ACTUALIZARASEGURADOS: 'Asegurados/EditarAsegurado/',
    ELIMINARASEGURADO: 'Asegurados/EliminarAsegurado/',
